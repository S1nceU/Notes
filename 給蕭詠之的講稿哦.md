...
We are Group 9, and today we’re here to share our presentation with you. Here’s a quick overview of what we’ll cover:

- We’ll explain each step of SSDLC in detail.
- Our focus is on analyzing the security of an open-source software called **Labelme**.

**First, let me briefly introduce what Labelme is:**  
Labelme is an image annotation tool that allows users to label and categorize images. It supports not only basic rectangle annotations but also polygon shapes for more precise labeling. This makes it especially useful for training datasets that need high accuracy. Additionally, Labelme can also work with video frames, allowing users to annotate and classify frame by frame. If you’re interested, you can find the source code for Labelme on GitHub.

Next, we chose Labelme as the target for our SSDLC analysis. Following the six phases of SSDLC, we used eight different testing principles and tools to analyze it. Now, I’ll pass it over to my teammates, who will go into more detail.

---

**(Other team members will present their parts here.)**

---

**Summary Section**  
After the detailed explanations from my teammates, I believe you now have a good understanding of the tools and methods we used. Let me wrap things up by summarizing what we’ve done with Labelme, the open-source annotation tool, in terms of security applications.

1. **Requirement Phase**  
    We used **OWASP ASVS**, which provides 14 security requirement frameworks. It helps developers check whether their applications address different types of risks. In our report, we highlighted some of these risks and explained how they could be mitigated.
    
2. **Design Phase**  
    For this phase, we used the **Microsoft Threat Modeling Tool**, which helps visualize system architecture and identify potential risks early on. The tool generates a list of risks and recommendations, making it easier to address vulnerabilities during the design stage.
    
3. **Implementation Phase**  
    We used three main tools to check and improve code security:
    
    - **SonarQube**: A SAST tool that reviews code for security issues and code smells, providing actionable feedback for developers.
    - **OWASP Secure Coding Practices**: A guideline to help developers ensure their code meets security standards.
    - **Safety**: A tool that scans for vulnerabilities in third-party dependencies and provides risk assessments to help developers fix issues proactively.
4. **Testing Phase**  
    For security testing, we chose **Mergebase**. It focuses on dependency management and generates detailed reports. Most of the issues we found were related to vulnerabilities in third-party libraries.
    
5. **Deployment and Maintenance Phases**  
    During deployment and maintenance, we used **PyInstaller** to package the application and ran it in a container. We also used **Kube-hunter** for penetration testing to ensure the app remains secure after deployment.
    

---

**Conclusion**  
That’s our complete analysis of Labelme’s security practices using SSDLC. Thank you all for listening, and we’re happy to take any questions or feedback!
